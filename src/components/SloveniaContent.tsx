        ...
        <div className="flex flex-col gap-16 md:gap-32 pb-16 md:pb-32">
            ...
            <section className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    {[
                        { src: "/results/slovenia/gbp-overview.png", alt: "Google Business Profile Overview", label: "Overview" },
                        { src: "/results/slovenia/gbp-calls.png", alt: "188 Direct Calls", label: "Calls" },
                        { src: "/results/slovenia/gbp-chats.png", alt: "49 Chat Clicks", label: "Chats" },
                        { src: "/results/slovenia/gbp-website.png", alt: "131 Website Clicks", label: "Website" }
                    ].map((item, i) => (
                        <motion.div
                            key={i}
                        ...
                        >
                            <div className="relative aspect-[9/16] bg-gradient-to-br from-slate-50 to-slate-100">
                                ...
                                <div className="hidden absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                                    <BarChart3 className="w-12 h-12 md:w-16 md:h-16 text-primary mb-4" />
                                    <p className="text-slate-900 font-black text-lg md:text-xl">{item.label}</p>
                                    <p className="text-slate-500 text-sm mt-2">GBP Performance Data</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
            ...
            <motion.a
                ...
                className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 bg-green-500 hover:bg-green-600 text-white p-4 md:p-5 rounded-full shadow-2xl hover:shadow-green-500/40 transition-all group"
            ...
            >
                ...
                <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-black px-2 py-1 rounded-full animate-pulse">
                    Chat
                </span>
            </motion.a>
        </div>
